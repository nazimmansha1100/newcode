...
public class medicalHistoryPage extends basePage {
   ...
   // WebElement msgdisplay;
    ...
    WebElement bodyTextWebElement;

    public @FindBy(css = "[class='btn btn-primary pull-right']")
    WebElement backButtonTextWebElement;

    public @FindBy(css = "[class='btn btn-primary pull-right']")
    WebElement backButtonWebElement;
   ...
   { try {
    ...
    {
        return bodyTextWebElement.getText().contains(text);
    }

    public String isBackButtonExist()
    {
        return backButtonTextWebElement.getText();
    }
